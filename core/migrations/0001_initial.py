# Generated by Django 2.2.9 on 2020-02-12 07:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, max_length=255, null=True, verbose_name='가게명')),
                ('star', models.CharField(blank=True, max_length=255, null=True, verbose_name='별점')),
                ('min_price', models.CharField(blank=True, max_length=255, null=True, verbose_name='최소주문금액')),
                ('del_time', models.CharField(blank=True, max_length=255, null=True, verbose_name='배달시간')),
